...
const DGEprojectform = () => {
  ...
  const addPostRequest = async (e) => {
    ...
    formField.append("biosample_t_file1", biosample_n_file1);
    formField.append("biosample_t_file2", biosample_n_file2);
    

    await axios({
      method: "post",
      url: `${process.env.REACT_APP_API_URL}/api/pipeline-dge`,
      headers: {
